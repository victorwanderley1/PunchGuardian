...
public class RegistroPontoServiceTest {
    ...
    public void registrarPontoErroProfissionalNaoEncontrado(){
        ...
        assertThrows(RuntimeException.class, () -> pontoService.registrarPonto(profissional.getId()), "Id Profissional "+profissional.getId()+" não existe");
        verify(profissionalRepository, times(1)).findById(profissional.getId());
    }

    @Test
    void testEspelhoDePontoSemIntervalo() {
